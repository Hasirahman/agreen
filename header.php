...
<html>
	<head>
		<title>AG - Engineering services</title>
		<!--meta-->
		<meta charset="UTF-8" />
				...
				<div class="header-top-bar">
					<ul class="contact-details clearfix">
						...
						<li class="template-mail">
							<a href="mailto:renovate@mail.com">info@ag.com</a>
						</li>
				...
				<div class="vertical-align-table column-1-1">
					<div class="header clearfix">
						<div class="logo vertical-align-cell">
							<!--<h1><a href="#" title="Renovate">RENOVATE</a></h1>-->
							<img src="images/logo.png" alt="logo AG" >
						</div>
